      ...
      <div className={`w-full max-w-md glass-panel p-0 overflow-hidden animate-scale-in ${
        ...
        <div className="px-6 pt-5 pb-6 space-y-4">
          ...
          <div className="rounded-xl bg-gray-50 border border-gray-200/60 p-4">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">What I do</p>
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[#0A66C2]/10#0A66C2]/15 px-3 py-2 text-sm font-medium text-[#0A66C2]#4B9AE4] hover:bg-[#0A66C2]/20 transition-colors"
            >
          ...
          {/* Email reveal */}
          {showEmail && (
            <div className="rounded-xl bg-emerald-50 border border-emerald-200/60 p-3 animate-fade-in">
