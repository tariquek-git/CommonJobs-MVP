    ...
    >
      <div className={`w-full max-w-lg glass-panel p-0 overflow-hidden animate-scale-in ${
        ...
        <div className="sticky top-0 bg-white/90 backdrop-blur-sm border-b border-gray-200/60 px-6 py-4 flex items-center justify-between">
          <h3 id="terms-modal-title" className="text-lg font-bold text-gray-900">Terms & Conditions</h3>
        ...
        <div className="px-6 py-5 space-y-5 text-sm text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <p>
              Fintech Commons is a side project built and maintained by Tarique Khan. It is not a company, not a startup, and not backed by anyone.
              It exists because job boards should be better, and sometimes a hobby project is the fastest way to prove that.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              This is pre-alpha software built in spare time. It may break, go down, lose data, or disappear entirely.
              There are no SLAs, no uptime guarantees, and no warranties of any kind.
              Use it as-is. If it helps you land a job or hire someone great, that's the whole point.
            </p>
          </div>
